...
- [UI user interface-pack-horror](https://toffeecraft.itch.io/ui-user-interface-pack-horror) 
...
> Was it original?  
> Definitely not. Other games were already using the same assets.
>
> Did I care?  
> This time, not at all.
>
> Remember — it's all about expectations (see the previous post).
> My goal was to create a game and publish something, not to create the next big indie hit.
